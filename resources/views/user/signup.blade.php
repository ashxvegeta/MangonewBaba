...
<body>
    <div class="modal-backdrop d-flex align-items-center justify-content-center">
        <div class="login-container">
            ...
            <div class="right-panel col-md-7 text-white position-relative mx-auto">
                ...
                <h3 class="mb-3 mb-md-2">Sign Up</h3> 
    ...
    <div class="mb-3 mb-md-4">
        <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" id="confirmpassword" placeholder="Enter Confirm Password">
