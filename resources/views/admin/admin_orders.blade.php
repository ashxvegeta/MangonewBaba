                            ...
                            <table class="table table-bordered table-dark table-hover text-white">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $order->status ? 'Success' : 'Pending' }}</td>
                                        <td>
                                            <a href="" class="btn btn-sm btn-warning mb-1">Edit</a>
                                          
                                            <a href="{{ route('admin.order.details', $order->id) }}" class="btn btn-sm btn-info mb-1">View order</a>

                                              <a href="" onclick="return confirm('Are you sure you want to delete this order?');"
